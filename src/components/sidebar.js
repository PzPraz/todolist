...
} from "../logic/projectFormHandlers";
import {
...
function createGeneralTaskSection() {
  ...
  const monthTasksBox = createTaskBox(
    "This Month",
    "month-tasks",
    "This Month",
  );
...
function createProjectControl() {
  ...
  const submitProjectButton = createControlButton(
    "Add",
    "submit-project-btn",
    "submit",
  );
  const cancelProjectButton = createControlButton(
    "Cancel",
    "cancel-btn",
    "button",
    handleProjectFormCancel,
...
function createProjectNav(project) {
  ...
  const removeProjectButton = createElementWithClasses(
    "button",
    "remove-project-btn",
  );
